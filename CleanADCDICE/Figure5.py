...
tbp.columns = ['Welfare','Warming above 2°C [°C yr]','Type','SCC(2020) [USD/tCO2]','SCC(2025) [USD/tCO2]','SCC(2030) [USD/tCO2]']
...
allsols = tbp
for field in ['SCC(2020) [USD/tCO2]','SCC(2025) [USD/tCO2]','SCC(2030) [USD/tCO2]']:
       plt.figure()
       markers=['^','o','^','s']
       for el in range(len(allsols['Type'].unique())):
              ...
              plt.scatter(sel['Warming above 2°C [°C yr]'].values.tolist(),
                     sel[field].values.tolist(), c=sel['\u0394 CBGE [%]'].values.tolist(), 
       ...
       plt.ylabel('Median SCC [USD/tCO2]')
       plt.colorbar()
