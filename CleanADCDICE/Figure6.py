...
for el in range(len(allsols['Type'].unique())):
       ...
       plt.scatter(sel['Warming above 2°C [°C yr]'].values.tolist(),
...
#        seltype = allsols['Type'].unique()[el]
#        sel = allsols.loc[allsols['Type']==seltype]
#        cm = ax[0].scatter(sel['Warming above 2°C [°C yr]'].values.tolist(),
...
#        ax[1].scatter(sel['Warming above 2°C [°C yr]'].values.tolist(),
#               sel['SCC(2030) [USD/tCO2]'].values.tolist(), c=sel['\u0394 CBGE [%]'].values.tolist(), 
#               cmap='viridis_r', vmin=tbp['\u0394 CBGE [%]'].min(),  vmax = tbp['\u0394 CBGE [%]'].max(), 
#               marker=markers[el], alpha=0.8, label=sel['Method'].values[0], edgecolor='k', s=30)
#        # cm = ax[0].scatter(sel['\u0394 CBGE [%]'].values.tolist(),
#        #        sel['SCC(2020) [USD/tCO2]'].values.tolist(), c=sel['Warming above 2°C [°C yr]'].values.tolist(), 
#        #        cmap='viridis', vmin=tbp['Warming above 2°C [°C yr]'].min(),  vmax = tbp['Warming above 2°C [°C yr]'].max(), 
#        #        marker=markers[el], alpha=0.8, label=sel['Method'].values[0], edgecolor='k', s=30)
#        # ax[1].scatter(sel['\u0394 CBGE [%]'].values.tolist(),
#        #        sel['SCC(2030) [USD/tCO2]'].values.tolist(), c=sel['Warming above 2°C [°C yr]'].values.tolist(), 
#        #        cmap='viridis', vmin=tbp['Warming above 2°C [°C yr]'].min(),  vmax = tbp['Warming above 2°C [°C yr]'].max(), 
#        #        marker=markers[el], alpha=0.8, label=sel['Method'].values[0], edgecolor='k', s=30)
#        # plt.scatter(sel['\u0394 CBGE [%]'].values.tolist(),
#        #        sel[field].values.tolist(), c=sel['Warming above 2°C [°C yr]'].values.tolist(), 
#        #        cmap='viridis_r', vmin=tbp['Warming above 2°C [°C yr]'].min(),  vmax = tbp['Warming above 2°C [°C yr]'].max(), 
#        #        marker=markers[el], alpha=0.8, label=sel['Method'].values[0], edgecolor='k')
# ax[0].set_xlabel('Warming above 2°C [°C yr]')
# ax[1].set_xlabel('Warming above 2°C [°C yr]')
# ax[0].set_ylabel('Median SCC [USD/tCO2]')
# # ax[0].set_xlabel('\u0394 CBGE [%]')
# # ax[1].set_xlabel('\u0394 CBGE [%]')
# plt.tight_layout()
# plt.subplots_adjust(bottom=0.05)
# cbar = plt.colorbar(cm, ax=ax[0:2], shrink=0.6, location='bottom')
# cbar.set_label('\u0394 CBGE [%]')
# # cbar.set_label('Warming above 2°C [°C yr]')
# plt.legend(loc='center left', bbox_to_anchor=(1.05, 0.5), ncol=1)
